...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()" ng-app="prsApp">
    ...
    <?php //echo "<pre>"; print_r($_SESSION);?>
      ...
      <div class="logo">
        <h1><a href="index.html"><span><?PHP IF(array_key_exists('userData', $_SESSION)){ ECHO $_SESSION['userData']['companyName'];}  ?></span></a></h1>
      </div>
      ...
      <div class="left-side-inner">
        ...
        <!--sidebar nav start-->
          <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <?php if($_SESSION['userData']['userType']==1){ ?>
            ...
            <?php } ?>
            <?php if($_SESSION['userData']['userType']==3){ ?>
            ...
            <?php } ?>
            <?php if($_SESSION['userData']['userType']==2){ ?>
            <li class="menu-list"><a href="#"><i class="lnr lnr-indent-increase"></i> <span>Product</span></a>  
              <ul class="sub-menu-list">
